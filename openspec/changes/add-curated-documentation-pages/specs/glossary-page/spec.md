...
The system SHALL provide a glossary page at `/glossary` that defines key Laraskills terminology.
...
The glossary SHALL display all terms with a consistent format (term name followed by definition).

#### Scenario: Terms use consistent layout
- **WHEN** a user views the glossary
- **THEN** each term SHALL be displayed with a bold or highlighted term name followed by a concise definition paragraph
